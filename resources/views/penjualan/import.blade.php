        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ url('/penjualan/download_template') }}" class="btn btn-info btn-sm">
                ...
                <div class="form-group">
                    ...
                    <small id="error-file_penjualan" class="error-text text-danger"></small>
                </div>
            </div>
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        Swal.fire({
                            ...
                            text: 'Tidak dapat mengimport data penjualan. Silakan coba lagi nanti.'
                        });
                    }
                });
                return false;
