        ...
        @else
            <form method="POST" action="{{ url('supplier/' . $supplier->supplier_id) }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-2 control-label col-form-label">Supplier Kode</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label class="col-2 control-label col-form-label">Supplier Nama</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label class="col-2 control-label col-form-label">Supplier Alamat</label>
                    <div class="col-10">
